	...
	while( true ) 
	{
		...
		for(i=0;i<img1.rows;i++)
		{
			for(j=0;j<img1.cols;j++)
			{
				...
				if(x>=10&&x<=84&&y>=67&&y<=153&&z>=47&&z<=132) img2.at<uchar>(i,j)=255;
				else if(x>=89&&x<=231&&y>=11&&y<=67&&z>=00&&z<=152) 
				{
		...
		if(flagshape==1)
		{
			...
			if(mc[i].x<img2.cols/6) cout<<"A"<<endl;      //we have to give command to arduino
			else if(mc[i].x>img2.cols/3) cout<<"D"<<endl;
			else cout<<"W"<<endl;
		}
		else if(flagshape==2)
		{
			...
			if(mc[i].x<2*img2.cols/3) cout<<"A"<<endl;      //we have to give command to arduino
			else if(mc[i].x>5*img2.cols/6) cout<<"D"<<endl;
			else cout<<"W"<<endl;
		}
		else
		{
			if(mc[0].x<img2.cols/3) cout<<"A"<<endl;      //we have to give command to arduino
			else if(mc[0].x>2*img2.cols/3) cout<<"D"<<endl;
			else cout<<"W"<<endl;
		}
